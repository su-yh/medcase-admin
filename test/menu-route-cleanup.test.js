...
test('removes obsolete dynamic menu route handling', () => {
  ...
  assert.match(permission, /function normalizeBackendRoutes\(routes\)/)
  assert.match(permission, /name: route\.routeName/)
  assert.match(permission, /path: route\.routePath/)
  assert.match(permission, /component: route\.vueComponentPath/)
